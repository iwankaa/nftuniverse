...
import { NFT, ThirdwebSDK, DirectListing } from "@thirdweb-dev/sdk";
import React, { useState } from "react";
import { MARKETPLACE_ADDRESS, NFT_COLLECTION_ADDRESS, NETWORK } from "../../../const/addresses";
...
export default function TokenPage({ nft, contractMetadata }: Props) {
  ...
  async function buyListing() {
    ...
    } else if (directListing && directListing[0]) {
